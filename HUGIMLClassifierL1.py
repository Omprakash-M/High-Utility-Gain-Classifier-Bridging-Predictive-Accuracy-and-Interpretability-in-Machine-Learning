...
class HUGIMLClassifierL1(ClassifierMixin, BaseEstimator):
    def __init__(self, 
        ...
        self.base_estimator = base_estimator #optional, default logistic regression with L1 regularization
    ...
    def fit(self, X_train, y_train):
        ...
        if self.base_estimator==None:
            # Changed from liblinear to L1-regularized Logistic Regression
            self.base_estimator = LogisticRegression(penalty='l1', solver='liblinear', random_state=0, max_iter=500)
